...
Pos: app/core/intent_router.py — Sprint2 chat 意图路由；挂 /api/ai/chat 预处理
...
_PORTFOLIO_RE = re.compile(
    r"(持仓|组合|仓位|我的股票|资产配置|portfolio|持有|调仓|仓位结构|"
...
def _hint_for(intent: str) -> str:
    ...
    return (
        "通用金融助手模式：有具体代码时再拉数据；无数据源时不编造数字。"
    )
